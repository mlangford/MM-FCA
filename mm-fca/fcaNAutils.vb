...
#Region "Set Closest Facility solver"
    ...
    Public Sub fcaNAsetClosestsolver2(ByRef m_NAContext As INAContext, ByRef cfObj As configParams, ByRef mode As String)
        ...
        Else
            naSolverSettings.ImpedanceAttributeName = cfObj.NWimpedanceBus
        End If
...
#Region "Set OD Matrix solver"
    ...
    Public Sub fcaNAsetODsolver2(ByRef m_NAContext As INAContext, ByVal cfObj As configParams, ByRef mode As String)
        ...
        Else
            odSolver.DefaultCutoff = cfObj.NWdefCutOffBus
        End If
